...
export default function Nav() {
    ...
    function updateNavUnderscore() {
      ...
      navLinks.forEach((link) => {
        ...
        if (section === activeSection) {
          ...
          const navContainer = link.closest(".hidden.lg\\:flex") as HTMLElement;
          if (navContainer) {
  ...
  return (
    <>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="hidden lg:flex items-center space-x-8 relative">
              ...
              <div
                ...
                style={{ width: 0, left: 0, margin: 0, padding: 0 }}
              ></div>
            </div>
      ...
      {/* Mobile Menu */}
      {isMobileMenuOpen && (
        <div className="fixed inset-x-0 top-20 bg-white/95 backdrop-blur-lg p-6 lg:hidden border-t border-accent z-40">
