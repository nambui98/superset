            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="text-center mb-20 animate-slide-up">
                    ...
                    <p className="text-xl text-gray-dark max-w-4xl mx-auto leading-relaxed">
                        Superset introduces two revolutionary products that work
                        together to solve liquidity fragmentation forever.
                    </p>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-8 mb-16">
                    <div className="glass-effect rounded-3xl p-8 text-center hover:scale-105 transform transition-all duration-300">
                        ...
                        <p className="text-gray-dark">
                            OFT Factory deploys your stablecoin to every chain
                    ...
                    <div className="glass-effect rounded-3xl p-8 text-center hover:scale-105 transform transition-all duration-300">
                        ...
                        <p className="text-gray-dark">
                            VirtualPools combine all liquidity across chains
                            into unified trading pools
                        </p>
                    </div>
                    ...
                    <div className="glass-effect rounded-3xl p-8 text-center hover:scale-105 transform transition-all duration-300">
                        ...
                        <p className="text-gray-dark">
                            SUP token incentivizes LPs to allocate liquidity
                ...
                <div className="glass-effect rounded-3xl p-12 text-center">
                    ...
                    <p className="text-xl text-gray-dark leading-relaxed max-w-4xl mx-auto">
                        <span className="text-dark font-semibold">
                            $5M spread across 5 chains gets the same liquidity
                            depth as $5M in one chain.
                        </span>
                        Your stablecoin becomes as liquid as Tether from day
                        one, enabling institutional-grade trading volumes across
                        all major chains.
                    </p>
                </div>
            </div>
