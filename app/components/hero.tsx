...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    const parallaxElements = document.querySelectorAll(".hero-bg > div > div");
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-20">
        <div ref={heroContentRef} className="text-center space-y-8">
          ...
          >
            ...
            <span className="monochrome-text block">As Liquid As Tether</span>
          </h1>

          <p
            ref={subtitleRef}
            className="text-xl md:text-2xl text-gray-dark leading-relaxed max-w-4xl mx-auto font-light"
          >
            The Native Liquidity Network that solves fragmented liquidity across
            300+ blockchains.
            <span className="text-dark font-medium">
              Aggregate all stablecoin liquidity into unified virtual pools.
            </span>
          </p>
          ...
          >
            <div className="stats-counter rounded-2xl p-6 glass-effect">
              ...
              <div className="text-sm text-gray-dark">Committed Liquidity</div>
            </div>
            <div className="stats-counter rounded-2xl p-6 glass-effect">
              <div
                className="text-3xl font-bold text-dark"
              ...
              <div className="text-sm text-gray-dark">New Chains (24mo)</div>
            </div>
            <div className="stats-counter rounded-2xl p-6 glass-effect">
              <div
                className="text-3xl font-bold text-dark"
              ...
              <div className="text-sm text-gray-dark">Market by 2030</div>
            </div>
            <div className="stats-counter rounded-2xl p-6 glass-effect">
              <div
                className="text-3xl font-bold text-dark"
              ...
              <div className="text-sm text-gray-dark">LP Yield</div>
            </div>
          </div>
          ...
          >
            <button className="px-10 py-4 bg-gradient-to-r from-curious-blue via-curious-blue-light to-curious-blue-lighter text-primary font-semibold hover:scale-105 transform transition-all duration-300 animate-glow rounded-full shadow-2xl">
              Deploy Your Token
            </button>
            <button className="px-10 py-4 border-2 border-curious-blue rounded-full text-curious-blue font-semibold hover:bg-curious-blue hover:text-primary transition-all duration-300">
              Read Whitepaper
            </button>
          </div>
        </div>
