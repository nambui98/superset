      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-20 animate-slide-up">
          ...
          <p className="text-xl text-gray-dark max-w-4xl mx-auto leading-relaxed">
            Systematic approach to capturing the fragmented stablecoin liquidity
            market.
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-dark">
                Partner with 7 existing issuers for initial deployments. Focus
                on measurable liquidity improvements and case studies.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-dark">
                Scale to 24 issuers with comprehensive data. Joint GTM with
                Plasma for issuer onboarding.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-dark">
                Capture majority market share through network effects and
                competitive moats from deepest liquidity.
              </p>
            </div>
          </div>
        </div>
